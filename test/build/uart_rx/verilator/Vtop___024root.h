...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final : public VerilatedModule {
  public:
    ...
    struct {
        ...
        CData/*0:0*/ uart_rx__DOT____Vtogcov__CLKip;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__RSTi;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__RXi;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__BAUD_RATE_RDi;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__BAUD_RATE_WEi;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__DONEo;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__READYo;
        CData/*7:0*/ uart_rx__DOT____Vtogcov__DATAo;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__half_rx_strb;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__rx_strb;
        CData/*3:0*/ uart_rx__DOT____Vtogcov__bit_idx;
        CData/*7:0*/ uart_rx__DOT____Vtogcov__data;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__rx;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__rst;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__done;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__ready;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__baud_rate_read;
        CData/*0:0*/ uart_rx__DOT____Vtogcov__baud_rate_we;
        CData/*1:0*/ uart_rx__DOT____Vtogcov__STATE;
        ...
        CData/*0:0*/ uart_rx__DOT__rx_stab__DOT____Vtogcov__SIGo;
        CData/*0:0*/ uart_rx__DOT__rx_stab__DOT____Vtogcov__meta_sig;
        ...
        CData/*0:0*/ uart_rx__DOT__rst_stab__DOT____Vtogcov__SIGo;
        CData/*0:0*/ uart_rx__DOT__rst_stab__DOT____Vtogcov__meta_sig;
        ...
        CData/*0:0*/ uart_rx__DOT__br_we_stab__DOT____Vtogcov__SIGo;
        CData/*0:0*/ uart_rx__DOT__br_we_stab__DOT____Vtogcov__meta_sig;
    };
    struct {
        ...
        CData/*0:0*/ uart_rx__DOT__br_rd_stab__DOT____Vtogcov__SIGo;
        CData/*0:0*/ uart_rx__DOT__br_rd_stab__DOT____Vtogcov__meta_sig;
        ...
        IData/*31:0*/ uart_rx__DOT____Vtogcov__BAUD_RATEi;
        ...
        IData/*31:0*/ uart_rx__DOT__baud_rate_mem__DOT____Vtogcov__DATAi;
        IData/*31:0*/ uart_rx__DOT__baud_rate_mem__DOT____Vtogcov__Qo;
        IData/*31:0*/ uart_rx__DOT__baud_rate_mem__DOT____Vtogcov__ram;
